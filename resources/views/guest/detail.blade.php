            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        @if($product->qty>0)
                        <form action="{{url("add-to-cart",["product"=>$product->id])}}"
                              method="get">
                        <div class="product__details__quantity">
                            <div class="quantity">
                                <div class="pro-qty">
                                    <input name="buy_qty" max="{{$product->qty}}" type="number"  value="1">
                                </div>
                            </div>
                        </div>
                        ...
                        <ul>
                            <li><b>Availability</b>
                                @if($product->qty > 0)<span class="text-success">In Stock</span>
